...
allow-origin = "/^https?:\/\/(?:(?:[a-z0-9]+\.)*63klabs\.net)$/i"
...
allow-debug-host = "/^https:\/\/sandbox\.63klabs\.net$/i"
...
; EXTEND YOUR APPLICATION USING THE FRAMEWORK
; THE FIELDS BELOW ARE NOT NECCESSARY UNTIL YOU START BUILDING UPON THE EXAMPLE
; SKIP TO THE EX LIBRIS SECTION BELOW IF YOU ARE FIRST GETTING STARTED
...
apikey = ""
; FORMAT:      string
; DESCRIPTION: Enter your Ex Libris API key for your application here. This is what will be sent on each API request
; DEFAULT:     ""
